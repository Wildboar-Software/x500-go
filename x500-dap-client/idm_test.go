...
func TestStrongAuth(t *testing.T) {
	...
	// NOTE: I don't actually care of auth succeeds. I just want to make sure
	// that encoding the request and decoding the response doesn't fail.
}
...
func TestSignedRequest(t *testing.T) {
	...
	// NOTE: I don't actually care if the request succeeds. I just want to make
	// sure that encoding the request and decoding the response succeeds.
}
